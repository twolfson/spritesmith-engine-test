...
exports.renderPngCanvas = exports._renderCanvas(config.multiplePngImages);
exports.renderJpgCanvas = exports._renderCanvas(config.multipleJpgImages);
exports.renderGifCanvas = exports._renderCanvas(config.multipleGifImages);
