...
exports._interpretImage = function (singleImage) {
  return function _interpretImageFn (params) {
    describe(params.engineName, function () {
      describe('interpretting an ' + singleImage.type + ' image file', function () {
...
exports.interpretManyImages = function (params, config) {
  describe(params.engineName, function () {
    describe('interpretting a ridiculous amount of images', function () {
      ...
      spritesmithUtils.interpretImages(params.engine, repeatingImages.filepaths);
...
exports.interpretLargeImage = function (params, config) {
  describe(params.engineName, function () {
    describe('interpretting a large image', function () {
      ...
      spritesmithUtils.interpretImages(params.engine, largeImage.filepaths);
